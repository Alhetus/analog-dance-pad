set(IXW_DIR "../lib/IXWebSocket/ixwebsocket")
...
set(IXWEBSOCKET_INCLUDE_DIRS ${CMAKE_CURRENT_SOURCE_DIR})

target_include_directories(ixwebsocket PUBLIC "../lib/IXWebSocket")

include_directories(${IXW_DIR})